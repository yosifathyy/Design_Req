  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-8">
        ...
        {idMismatch && (
          <IDMismatchNotice authId={idMismatch.authId} dbId={idMismatch.dbId} />
        )}
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-5xl font-display font-bold text-black mb-2">
                  Welcome back, {userProfile?.name?.split(" ")[0] || "Creator"}!
                </h1>
        ...
        >
          ...
          {/* Unread Chats */}
          <Link to="/chat">
            <Card className="stat-card group relative bg-gradient-to-br from-festival-pink to-festival-magenta border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 transition-all duration-200 cursor-pointer p-6">
              <div className="flex items-center justify-between mb-4">
        ...
        >
          ...
          <Link to="/chat">
            <Card className="group bg-gradient-to-br from-blue-500 to-purple-600 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all duration-300 cursor-pointer p-8 text-center">
          ...
          <Link to="/payments">
            <Card className="group bg-gradient-to-br from-emerald-500 to-teal-600 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] hover:-translate-x-1 hover:-translate-y-1 transition-all duration-300 cursor-pointer p-8 text-center">
