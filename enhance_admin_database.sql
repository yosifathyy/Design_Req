-- Enhanced Admin Database Structure
...
-- Create triggers for activity logging on critical tables
CREATE TRIGGER log_users_activity
  AFTER INSERT OR UPDATE OR DELETE ON users
  FOR EACH ROW EXECUTE FUNCTION log_admin_activity();

CREATE TRIGGER log_design_requests_activity
  AFTER INSERT OR UPDATE OR DELETE ON design_requests
  FOR EACH ROW EXECUTE FUNCTION log_admin_activity();
